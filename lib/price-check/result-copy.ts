...
export const factorLabels: Record<string, string> = {
  ...
  TRANSACTION_TYPE_MIXED: "Transaction type",
  DOCUMENTATION_MIXED: "Documentation",
  CORE_TERMS_MIXED: "Core terms",
  WARRANTY_MIXED: "Warranty",
  OLD_EVIDENCE: "Evidence age",
  AOG_CONTEXT_MIXED: "AOG context",
  PART_RELATIONSHIP_USED: "Part relationship",
  QUANTITY_VARIANCE: "Quantity",
  INSUFFICIENT_DATA: "Evidence limitations",
  SINGLE_OBSERVATION: "Evidence limitations",
  LIMITED_EVIDENCE: "Evidence limitations",
};
