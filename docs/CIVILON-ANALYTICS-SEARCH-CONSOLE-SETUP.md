...
- Custom-event trigger allowlist: `price_check_view`, `price_check_start`, `price_check_submit`, `price_check_upload_started`, `price_check_upload_completed`, `rfq_submit`, `contact_submit`, `aog_call_click`, `whatsapp_click`, `buy_sell_hub_view`, `buy_request_view`, `buy_request_start`, `buy_request_submit`, `buy_request_verification_confirmed`, `sell_submission_view`, `sell_submission_start`, `sell_submission_upload_started`, `sell_submission_upload_completed`, `sell_submission_submit`, `sell_submission_verification_confirmed`, `sell_evidence_request_opened`, `sell_evidence_request_submitted`, `sell_inventory_freshness_opened`, and `sell_inventory_freshness_answered`.
