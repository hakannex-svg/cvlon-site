...
export function SiteFooter() {
  ...
  const sellSubmissionEnabled = isSellSubmissionEnabled();
  ...
  return <footer><div className="shell footer-grid"><div><a className="brand brand-footer" href="/"><img src="/civilon-logo-dark.svg" alt="Civilon"/></a><p>Business-aircraft parts sourcing, repair management and AOG coordination from Englewood Cliffs, New Jersey.</p></div><div><strong>Contact</strong><a href={`mailto:${siteConfig.email}`}>{siteConfig.email}</a><a href={`tel:${siteConfig.officeTel}`}>Office & AOG: {siteConfig.officePhone}</a><span>375 Sylvan Ave, Suite 23<br/>Englewood Cliffs, NJ 07632</span></div><div><strong>Services</strong><a href="/parts">Parts sourcing</a>{marketplaceEnabled && <a href="/buy-sell-aircraft-parts/buy">{PUBLIC_CTA.buy}</a>}{sellSubmissionEnabled && <a href="/buy-sell-aircraft-parts/sell">{PUBLIC_CTA.sell}</a>}{priceCheckEnabled && <a href="/price-check">Aircraft Part Price Check</a>}<a href="/aog-services">AOG support</a><a href="/repair-management">Repair management</a></div><div><strong>Company</strong><a href="/quality-assurance">Quality assurance</a><a href="/about-us">About Civilon</a><a href="/contact-us">Contact</a><a href="/privacy-policy">Privacy Policy</a><a href="/terms-of-use">Terms of Use</a><PrivacyChoicesButton /><a className="footer-quote" href={searchHref}>{PUBLIC_CTA.buy} →</a></div></div><div className="shell footer-bottom"><span>© 2026 Civilon LLC · Est. 2012. All rights reserved.</span><span>Worldwide coordination, subject to destination and compliance requirements.</span></div></footer>;
}
