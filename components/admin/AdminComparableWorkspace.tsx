...
export function AdminComparableWorkspace({
  ...
  return <section className="admin-analysis-workspace" aria-labelledby="analysis-workspace-title">
    <div className="admin-analysis-heading"><div><p className="admin-eyebrow">Step 3 · Evidence review</p><h2 id="analysis-workspace-title">Comparable evidence</h2><p>Select only relevant governed observations and record why each is included or excluded. The deterministic engine calculates the observed indicators; AI does not calculate the range.</p><a className="admin-guide-link" href="/admin/help#comparables">What is this?</a></div><span className="admin-engine-label">Engine 1.0</span></div>
