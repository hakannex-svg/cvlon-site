      ...
      <section className="price-check-promotion price-check-promotion-feature" aria-labelledby="price-check-promotion-homepage">
        <div className="shell price-check-feature-layout">
          <div className="price-check-feature-copy">
            ...
            <p className="price-check-feature-intro">Submit the part number, condition, and quoted or purchased price. Civilon reviews available comparable evidence and returns a human-reviewed Price Check to help you understand whether the price appears below, within, or above the observed comparable range.</p>
            <ul className="price-check-benefits" aria-label="Price Check benefits">
              <li><strong>Human-reviewed</strong><span>Civilon reviews the transaction and available comparable evidence before release.</span></li>
          ...
          <aside className="price-check-flow" aria-label="How Price Check works">
            ...
            <ol>
              ...
              <li><span>03</span><div><strong>Result</strong><p>Receive a private, human-reviewed Price Check.</p></div></li>
            </ol>
