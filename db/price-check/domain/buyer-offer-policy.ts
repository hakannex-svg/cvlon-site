...
export const BUYER_OFFER_DELIVERY_QUEUED_ACTION = "BUYER_OFFER_DELIVERY_QUEUED";
export const BUYER_OFFER_NOTIFICATION_SENT_ACTION = "BUYER_OFFER_NOTIFICATION_SENT";
export const BUYER_OFFER_NOTIFICATION_FAILED_ACTION = "BUYER_OFFER_NOTIFICATION_FAILED";
export const BUYER_OFFER_BUYER_RESPONDED_ACTION = "BUYER_OFFER_BUYER_RESPONDED";

export const BUYER_OFFER_DELIVERY_MESSAGE_TYPE = "BUYER_OFFER_TO_BUYER";
export const BUYER_OFFER_RESPONSE_MESSAGE_TYPE = "BUYER_OFFER_RESPONSE_INTERNAL";
export const BUYER_OFFER_AGGREGATE_TYPE = "buyer_offer";
